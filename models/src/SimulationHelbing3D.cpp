#include "../include/SimulationHelbing3D.h"

namespace craal {

SimulationHelbing3D::SimulationHelbing3D() :
...
void SimulationHelbing3D::p_delete2()
{
...
void SimulationHelbing3D::reset()
{
    for (int i = 0; i < g_nPedestrian; i++) {
...
void SimulationHelbing3D::addObstacleCoords(float s_startx, float s_starty, float s_endx, float s_endy)
{
    // 	g_sim->addObstacle(s_startx, s_starty, s_endx, s_endy);
}

void SimulationHelbing3D::setPosition(int s_indPedestrian, float s_x, float s_y, float s_z)
{
    g_sim->setPos(s_indPedestrian, s_x, s_y, s_z);
}

void SimulationHelbing3D::setVelocity(int s_indPedestrian, float s_x, float s_y, float s_z)
{
    g_sim->setVel(s_indPedestrian, s_x, s_y, s_z);
}

void SimulationHelbing3D::setGoal(int s_indPedestrian, float s_x, float s_y, float s_z)
{
...
void SimulationHelbing3D::doStep(float s_dt)
{
