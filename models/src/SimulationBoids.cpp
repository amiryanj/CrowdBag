#include "../include/SimulationBoids.h"

namespace craal {

SimulationBoids::SimulationBoids() :
...
void SimulationBoids::p_delete2()
{
...
void SimulationBoids::addObstacleCoords(float s_startx, float s_starty, float s_endx, float s_endy)
{
    g_sim->addObstacle(s_startx, s_starty, s_endx, s_endy);
}

void SimulationBoids::setPosition(int s_indPedestrian, float s_x, float s_y)
{
    g_sim->setPos(s_indPedestrian, s_x, s_y);
}

void SimulationBoids::setVelocity(int s_indPedestrian, float s_x, float s_y)
{
    g_sim->setVel(s_indPedestrian, s_x, s_y);
}

void SimulationBoids::setGoal(int s_indPedestrian, float s_x, float s_y)
{
    g_gx[s_indPedestrian] = s_x;
    g_gy[s_indPedestrian] = s_y;
}

void SimulationBoids::doStep(float s_dt)
{
...
void SimulationBoids::setAgentRadius(int s_indPedestrian, float value)
{
    g_params[s_indPedestrian * 5 + 2] = value;
    g_sim->setRadius(s_indPedestrian, g_params[s_indPedestrian*2+0]);
}

void SimulationBoids::setAgentSpeed(int s_indPedestrian, float value)
{
